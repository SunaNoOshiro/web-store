...
<div >	
	<div class="update-form">
		...
		<form action="user" method="post">
			<input name="from" value="update_profile" type="hidden" /> 
			...
			<div class="col-sm-5">	
				...
				</select> <input type="text" placeholder="State" name="state" /> <input
					type="text" placeholder="City" name="city" /> <input type="text"
					placeholder="Address" name="address" /> <select name="sex">
